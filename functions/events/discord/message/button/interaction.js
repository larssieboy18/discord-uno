...
let startGame = await http.post(`https://${context.service.path[0]}.autocode.dev/${context.service.path[1]}@${context.service.environment}/events/discord/uno/start/`, '', {auth: context.service.hash}, {event: context.params.event, game: game, allAccepted: allAccepted,})
